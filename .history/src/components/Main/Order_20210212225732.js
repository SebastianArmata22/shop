...
function Order(props){
    ...
    const handleButtonClicked= ()=>{
     ...
     const choosePayment=(payment,name)=>{
        ordercontext.changePaymentMethod(payment)
        NotificationManager.success(`payment selected: ${name}`)
   ...
   <div className='profile-container'>
       <h3>The recipient's details</h3>
        ...
        <div className='payment-container'>
            <h3>Payment</h3>
            <div >
                <div className="payment-item" onClick={()=>choosePayment(1,'google pay')}>
                    <img src={gpay} alt='gpay'></img>
                    <p>Google Pay</p>
                </div>
                <div className="payment-item" onClick={()=>choosePayment(2,'paypal')}>
                    <img src={paypal} alt='paypal'></img>
                    <p>PayPal</p>
                </div>
                <div className="payment-item">
                    <img src={cod} style={{backgroundColor: '#ffffff'}} onClick={()=>choosePayment(3, 'cash on delivery')} alt='cod'></img>
